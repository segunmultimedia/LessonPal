  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-border/50 shadow-xl shadow-black/5 p-6 sm:p-8">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">Sign in to continue to LessonPal</p>
      </div>
      ...
      <form action={async () => {
        // use next-auth/react client signIn for Google as it handles redirects natively well
